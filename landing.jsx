    ...
    <Section id="fun" kicker="07 / развлекательная программа" title={<>После танцев — <em>приключения</em>.</>} highlight>
      <div className="fun-grid">
        <div className="fun-text">
          <p className="lede">
            После классов можно остаться на обед в кафе и развлекательную программу — это по желанию. Дальше каждый день — новое место. Программа зависит от мероприятий в Минске и погоды, финальное расписание — после 1 июня.
          </p>
          <p className="mono-note">
            * Обед и входные билеты оплачиваются отдельно.
            С детьми на всех мероприятиях присутствует педагог.
          </p>
          <p className="mono-note">
            Ребёнка можно забрать сразу после классов, без обеда и развлекательной программы.
          </p>
        </div>
